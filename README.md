...
This is the handout and homework repository for the course "ME 539 Introduction to Scientific Machine Learning" which is being taught during Summer 2022 by Prof. [Ilias Bilionis](https://www.predictivesciencelab.org/authors/ebilionis/) at Purdue University.
...
This course evolved from the ME 597 "Data Analytics for Scientists and Engineeers" taught two times by Prof. Bilionis, and the ME 597/MA 598 "Introduction to Uncertainty Quantification."
The old version covers some material that is not covered here, e.g., polyomial chaos, inverse problems.
If you are interested in these topics, you can find the material [here](https://github.com/PredictiveScienceLab/uq-course).
