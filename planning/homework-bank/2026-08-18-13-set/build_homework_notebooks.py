#!/usr/bin/env python3
"""Build the Fall 2026 student-facing homework notebook drafts.

Homework 7, 10, and 12 are intentionally excluded.  Each generated notebook
contains exactly one manual-mathematics problem and one scaffolded Colab study.
The notebooks contain prompts and infrastructure, not solutions.
"""
...
def homework_11() -> nbf.NotebookNode:
    cells = opening(
    ...
    cells += [
        ...
        code(
            ...
            train_idx, remainder_idx = train_test_split(
                idx, test_size=0.30, random_state=53911, shuffle=True
            )
            valid_idx, test_idx = train_test_split(
                remainder_idx, test_size=0.50, random_state=53912, shuffle=True
            )
...
def homework_13() -> nbf.NotebookNode:
    cells = opening(
